...
## 缘起
 ...
 [源码地址](https://github.com/Chad97/My-notes/tree/master/shell) github 求点个star ⭐️
 
### shell环境
> `shell`是一门脚本语言，Shell 是一个用 C 语言编写的程序，它是用户使用 Linux 的桥梁。Shell 既是一种命令语言，又是一种程序设计语言。

> 我们常见的操作系统如mac的OSX系统，打开终端就可以执行我们的`shell(Bash shell)`。windows系统中我们的`cmd`终端也可以执行，`Linux`系统一等公民的`shell`环境
