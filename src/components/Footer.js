...
const Footer = ({ theme, count = 3 }) => {
  return (
    ...
    >
      ...
      <div>
        原创文章遵循
        <a target="_blank" href="https://creativecommons.org/licenses/by-sa/4.0/deed.zh">
          CC BY-SA 4.0
        </a>
        授权许可，转载请注明出处
      </div>
